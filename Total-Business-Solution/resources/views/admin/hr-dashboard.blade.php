                    ...
                    <div class="col-md-12 m-b-30">
                        ...
                        <div class="d-block d-lg-flex flex-nowrap align-items-center">
                            <div class="page-title mr-4 pr-4 border-right">
                                <h1 class="text-capitalize">{{ $user->role->role_type }} dashboard</h1>
                            </div>
                                    ...
                                    <ol class="breadcrumb p-0 m-b-0">
                                        <li class="breadcrumb-item">
                                            ...
                                            @elseif($user->role->id==3)
                                                <a href="{{ route('account.dashboard') }}"><i class="ti ti-home"></i></a>
                                            @elseif($user->role->id==4)
                                                <a href="{{ route('hr.dashboard') }}"><i class="ti ti-home"></i></a>
                                            @elseif($user->role->id==5)
                                                <a href="{{ route('purchase.dashboard') }}"><i class="ti ti-home"></i></a>
                                            @endif
                                        </li>
                                        <li class="breadcrumb-item">
                                            Dashboard
                                        </li>
                                        <li class="breadcrumb-item active text-primary text-capitalize" aria-current="page">{{ $user->role->role_type }} dashboard</li>
                                    </ol>
                                </nav>
                            </div>
