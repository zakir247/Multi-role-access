...
{{--                    <span class="nav-label label label-danger">9</span>--}}
                ...
                <ul aria-expanded="false">
                    @if($user->role->id==1)
                    <li class="{{ 'dashboard'==request()->path()?'active':'' }}"> <a href='{{ route('dashboard') }}' class="text-capitalize">{{ $user->role->role_type }}</a> </li>
                    <li class="{{ 'account'==request()->path()?'active':'' }}"> <a href='{{ route('account') }}'>Accounts Department</a> </li>
                    <li class="{{ 'hr'==request()->path()?'active':'' }}"> <a href='{{ route('hr') }}'>HR. Admin Department</a> </li>
                    <li class="{{ 'purchase'==request()->path()?'active':'' }}"> <a href='{{ route('purchase') }}'>Purchase Department</a> </li>
                    <li> <a href='index-dating.html'>Sells Department</a> </li>
                    @elseif($user->role->id==3)
                        <li class="{{ 'account.dashboard'==request()->path()?'active':'' }}"> <a href='{{ route('account.dashboard') }}' class="text-capitalize">{{ $user->role->role_type }}</a> </li>
                    @elseif($user->role->id==4)
                        <li class="{{ 'hr.dashboard'==request()->path()?'active':'' }}"> <a href='{{ route('hr.dashboard') }}' class="text-capitalize">{{ $user->role->role_type }}</a> </li>
                    @elseif($user->role->id==5)
                        <li class="{{ 'purchase.dashboard'==request()->path()?'active':'' }}"> <a href='{{ route('purchase.dashboard') }}' class="text-capitalize">{{ $user->role->role_type }}</a> </li>
                    @endif
